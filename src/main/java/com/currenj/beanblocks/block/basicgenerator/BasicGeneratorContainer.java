...
public class BasicGeneratorContainer extends Container {
    ...
    private final TileEntityBasicGenerator tileEntityBasicGenerator;

    public BasicGeneratorContainer(InventoryPlayer playerInv, final TileEntityBasicGenerator basicGenerator) {
        IItemHandler inventory = basicGenerator.getInventory();
        tileEntityBasicGenerator = basicGenerator;
        addSlotToContainer(new SlotItemHandler(inventory, 0, 80, 79) {
            @Override
            public void onSlotChanged() {
                basicGenerator.markDirty();
            }
        });
    ...
    public TileEntityBasicGenerator getTileEntity() {
        return tileEntityBasicGenerator;
    }
}
