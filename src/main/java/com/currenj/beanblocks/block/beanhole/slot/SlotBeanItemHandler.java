package com.currenj.beanblocks.block.beanhole.slot;
...
public class SlotBeanItemHandler extends Slot
{
    private static IInventory emptyInventory = new InventoryBasic("[Null]", true, 0);
    private final IItemHandler itemHandler;
    private final int index;

    public SlotBeanItemHandler(IItemHandler itemHandler, int index, int xPosition, int yPosition)
    {
