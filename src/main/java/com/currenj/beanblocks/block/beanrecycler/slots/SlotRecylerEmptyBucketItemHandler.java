...
public class SlotRecylerEmptyBucketItemHandler extends Slot
{
    private static IInventory emptyInventory = new InventoryBasic("[Null]", true, 0);
    private final IItemHandler itemHandler;
    private final int index;

    public SlotRecylerEmptyBucketItemHandler(IItemHandler itemHandler, int index, int xPosition, int yPosition)
    {
    ...
    {
        return Block.getBlockFromItem(stack.getItem()) instanceof BlockBeanBucket;
    }
