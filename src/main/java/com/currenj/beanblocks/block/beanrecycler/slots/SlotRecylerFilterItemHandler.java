...
public class SlotRecylerFilterItemHandler extends Slot
{
    private static IInventory emptyInventory = new InventoryBasic("[Null]", true, 0);
    private final IItemHandler itemHandler;
    private final int index;

    public SlotRecylerFilterItemHandler(IItemHandler itemHandler, int index, int xPosition, int yPosition)
    {
    ...
    public boolean isItemValid(ItemStack stack)
    {
        ...
        return stack.getItem() instanceof ItemRecyclerFilter;
    }
