...
public class ChunkGeneratorUnderbean implements IChunkGenerator
{
    ...
    protected Biome biome = ModBiomes.underbeanbiome;
    protected IBlockState baseBlock = ModBlocks.beanBlockHardened.getDefaultState();
     ...
     */
    public ChunkGeneratorUnderbean(World worldIn)
    {
        // DEBUG
        ...
        //MapGenVillage.VILLAGE_SPAWN_BIOMES.add(ModBiomes.underbeanbiome);
