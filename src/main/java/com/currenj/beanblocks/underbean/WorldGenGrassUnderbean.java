...
public class WorldGenGrassUnderbean extends WorldGenerator
{
    private Block grassBlock = Blocks.COAL_BLOCK;
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        ...
        for (int i = 0; i < 128; ++i)
        {
            ...
            if (worldIn.isAirBlock(blockPos) && worldIn.getBlockState(blockPos.down()) instanceof BlockBean)
            {
