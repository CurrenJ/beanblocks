...
public class WorldTypeUnderbean extends WorldType
{

    /**
     * Instantiates a new world type cloud.
     */
    public WorldTypeUnderbean()
    {
        super(ModWorldGen.BEAN_NAME);

        // DEBUG
        System.out.println("Constructing WorldTypeUnderbean");
    }
    ...
    {
        return new BiomeProviderUnderbean();
    }
